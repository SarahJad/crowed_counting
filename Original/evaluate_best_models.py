...
import train_best_models as train
...
def main(cfg):
    ...
    loaded_struct2 = torch.load(
        pjn(orig_cwd, "/content/drive/MyDrive/MastersResearch/Codes/S-DCNet/S-DCNet-2/CL_checkpoints_A/epoch_0212.pth"))

    model2 = SDCNet(
        label2count_list,
        cfg.model.supervised,
        load_pretr_weights_vgg=False)
    model2.load_state_dict(loaded_struct2['model_state_dict'], strict=True)
    ...
    loaded_struct3 = torch.load(
        pjn(orig_cwd, "/content/drive/MyDrive/MastersResearch/Codes/S-DCNet/S-DCNet-2/CL_checkpoints_A/epoch_0208.pth"))

    model3 = SDCNet(
        label2count_list,
        cfg.model.supervised,
        load_pretr_weights_vgg=False)
    model3.load_state_dict(loaded_struct3['model_state_dict'], strict=True)
