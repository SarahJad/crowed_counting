        ...
        for epoch in range(self.cfg.train.start_epoch, self.cfg.train.num_epochs):
            ...
            for sample in self.train_loader:
                ...
                cross_entropy_loss_terms = loss.counter_loss(
                    ...
                    (cls0_logits, cls1_logits, cls2_logits),epoch , True)
                
                merging_loss = loss.merging_loss(gt_div2, DIV2,epoch , True)
            ...
            if epoch % self.cfg.validation.save_ckpt_every_epochs == 0:
                ...
                if not os.path.isdir(pjn(self.tbx_wrtr_dir, 'CL_VGG19_checkpoints_'+self.cfg.dataset.part)):
                    os.mkdir(pjn(self.tbx_wrtr_dir, 'CL_VGG19_checkpoints_'+self.cfg.dataset.part))
                self.save_ckpt(
                    epoch=epoch,
                    fpath=pjn(self.tbx_wrtr_dir, 'CL_VGG19_checkpoints_'+self.cfg.dataset.part, nm))
