...
class SDCNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv3_features = make_layers_vgg([256, 256, 256, 256, 'M'], in_ch=128)
        self.conv4_features = make_layers_vgg([512, 512, 512, 512, 'M'], in_ch=256)
        self.conv5_features = make_layers_vgg([512, 512, 512, 512, 'M'], in_ch=512)
        ...
        if load_pretr_weights_vgg:
            pretr_dict = torchvision.models.vgg19(pretrained=True).state_dict()
