...
from switch_network import SwitchNet
    ...
    def train(self):
        ...
        for epoch in range(self.cfg.train.start_epoch, self.cfg.train.num_epochs):
            ...
            if epoch % self.cfg.validation.save_ckpt_every_epochs == 0:
                ...
                if not os.path.isdir(pjn(self.tbx_wrtr_dir, 'switch_checkpoints_'+self.cfg.dataset.part)):
                    os.mkdir(pjn(self.tbx_wrtr_dir, 'switch_checkpoints_'+self.cfg.dataset.part))
                self.save_ckpt(
                    epoch=epoch,
                    fpath=pjn(self.tbx_wrtr_dir, 'switch_checkpoints_'+self.cfg.dataset.part, nm))
